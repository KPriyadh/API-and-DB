...
async function fetchUser(): Promise<UserInfo[]> {
    const apiUrl = "http://localhost:5036/api/userinfo";
...
async function addUser(user: UserInfo): Promise<void>  {
    const response = await fetch("http://localhost:5036/api/userinfo",{
        method: 'POST',
        headers: {
...
async function fetchTravel(): Promise<Travel[]> {
    const apiUrl = "http://localhost:5036/api/travel";
    const response = await fetch(apiUrl);
    if (!response.ok) {
...
async function addTravel(travel: Travel): Promise<void>  {
    const response = await fetch("http://localhost:5036/api/travel",{
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
async function fetchTicket(): Promise<Ticket[]> {
    const apiUrl = "http://localhost:5036/api/ticket";
    const response = await fetch(apiUrl);
    if (!response.ok) {
...
async function addTicket(ticket: Ticket): Promise<void>  {
    const response = await fetch("http://localhost:5036/api/ticket",{
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
async function updateUser(id: number, userInfo: UserInfo): Promise<void> {
    const response = await fetch(`http://localhost:5036/api/userinfo/${id}`, {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json'
      },
  ...
  async function updateTravel(id: number, travel: Travel): Promise<void> {
    const response = await fetch(`http://localhost:5036/api/travel/${id}`, {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json'
      },
  ...
  async function updateTicket(id: number, ticket: Ticket): Promise<void> {
    const response = await fetch(`http://localhost:5036/api/ticket/${id}`, {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json'
      },
