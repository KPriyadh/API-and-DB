...
function fetchUser() {
    return __awaiter(this, void 0, void 0, function* () {
        const apiUrl = "http://localhost:5261/api/User";
...
function addUser(user) {
    return __awaiter(this, void 0, void 0, function* () {
        const response = yield fetch("http://localhost:5261/api/User", {
            method: 'POST',
            headers: {
...
function fetchMedicine() {
    return __awaiter(this, void 0, void 0, function* () {
        const apiUrl = 'http://localhost:5261/api/Medicine';
        const response = yield fetch(apiUrl);
        if (!response.ok) {
...
function addMedicine(medicine) {
    return __awaiter(this, void 0, void 0, function* () {
        const response = yield fetch('http://localhost:5261/api/Medicine', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
function fetchOrder() {
    return __awaiter(this, void 0, void 0, function* () {
        const apiUrl = 'http://localhost:5261/api/Order';
        const response = yield fetch(apiUrl);
        if (!response.ok) {
...
function addOrder(order) {
    return __awaiter(this, void 0, void 0, function* () {
        const response = yield fetch('http://localhost:5261/api/Order', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
function updateMedicine(id, medicine) {
    return __awaiter(this, void 0, void 0, function* () {
        const response = yield fetch(`http://localhost:5261/api/Medicine/${id}`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json'
            },
...
function updateUser(id, userInfo) {
    return __awaiter(this, void 0, void 0, function* () {
        const response = yield fetch(`http://localhost:5261/api/User/${id}`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json'
            },
...
function updateOrder(id, order) {
    return __awaiter(this, void 0, void 0, function* () {
        const response = yield fetch(`http://localhost:5261/api/Order/${id}`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json'
            },
...
form.addEventListener("submit", (event) => {
    var _a;
    let newUserEmail = document.getElementById('email').value.trim();
    let newUserPassword = document.getElementById('password').value.trim();
    let newUserConfirmPassword = document.getElementById('cpassword').value.trim();
    let newUserPhoneNumber = document.getElementById('newUserPhonenumber').value.trim();
    let newuserphoto = document.getElementById('photo');
...
function userHistory() {
    return __awaiter(this, void 0, void 0, function* () {
        //  let userdisplay =document.getElementById('userDisplay') as HTMLLabelElement;
        //  userdisplay.style.display="block";
        const userList = yield fetchUser();
        let userdisplaytable = document.querySelector("#userdisplay tbody");
...
function ExportData() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let data = "Medicine ID,User ID,Medicine Name,Medicine Count,Order Status";
        const orderList = yield fetchOrder();
        for (let i = 0; i < orderList.length; i++) {
            data = data + `\n` + `${orderList[i].userID},${orderList[i].medicineID},${orderList[i].medicineName},${orderList[i].medicineCount},${orderList[i].orderStatus}\n`;
        }
