...
async function addUser(user: UserInfo): Promise<void>  {
    const response = await fetch("http://localhost:5261/api/User",{
        method: 'POST',
        headers: {
...
async function addMedicine(medicine: Medicine): Promise<void> {
    const response = await fetch('http://localhost:5261/api/Medicine', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
...
async function addOrder(order: Order): Promise<void> {
    const response = await fetch('http://localhost:5261/api/Order', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
...
async function updateMedicine(id: number, medicine: Medicine): Promise<void> {
    const response = await fetch(`http://localhost:5261/api/Medicine/${id}`, {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json'
      },
...
//updateUser
  async function updateUser(id: number, userInfo: UserInfo): Promise<void> {
    const response = await fetch(`http://localhost:5261/api/User/${id}`, {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json'
      },
...
async function updateOrder(id: number, order: Order): Promise<void> {
    const response = await fetch(`http://localhost:5261/api/Order/${id}`, {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json'
      },
...
async function userHistory(){
    ...
    const userList = await fetchUser();
    let userdisplaytable = document.querySelector("#userdisplay tbody") as HTMLTableSectionElement;
...
async function ExportData(){
    ...
    let data: string="Medicine ID,User ID,Medicine Name,Medicine Count,Order Status";
    const orderList = await fetchOrder();
